...
与协议文档 `YF0226C220054-V1.0-...B1024-01固件.md` 3.1–3.7 对齐。
...
| 3.3 | 0x03 | `02 7F 08 01 03 FF 07 23` | CN43 打印机电源 |
| 3.4 | 0x04 | `02 7F 08 01 04 FF 05 13` | CN39 5V 输出 |
| 3.5 | 0x05 | `02 7F 08 01 05 FF 04 83` | CN47 12V 输出 |
| 3.6 | 0x06 | `02 7F 08 01 06 FF 04 73` | CN13 接近开关 5V |
