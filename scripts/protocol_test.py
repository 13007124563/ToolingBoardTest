...
PROTOCOL_CASES = [
    ...
    ("3.3 Printer CN43 (read high)", "02 7F 09 01 03 FF 01 9E C2", "02 7F 0B 01 03 00 00 04 B4 A9 52"),
    ("3.4 5V CN39 (read high)", "02 7F 09 01 04 FF 01 2F 03", "02 7F 0B 01 04 00 00 01 F0 1F F1"),
    ("3.5 12V CN47 (read high)", "02 7F 09 01 05 FF 01 7E C3", "02 7F 0B 01 05 00 00 04 B5 E0 92"),
    ("3.6 Proximity CN13 (read high)", "02 7F 09 01 06 FF 01 8E C3", "02 7F 0B 01 06 00 00 01 F0 66 31"),
